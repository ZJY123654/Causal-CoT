# 24Model-guided large language models for knowledge graph generation and causal effect estimation in hydraulic engineering construction accidents
...
```python
graph = Graph("your_neo4j_uri", auth=("neo4j", "your_password"))
```
